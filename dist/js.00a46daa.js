...
var moodInputBox = document.getElementById('moodInput');
...
function getTaskHTML(element) {
  return "\n        <div class=\"feelingThumbnail\" id=\"".concat(element.mood, "\">\n            <h2 class=\"genEmotion\">").concat(element.mood, "</h2>\n            <p class=\"genTask\">").concat(element.task, "</p>\n        </div>\n    ");
}

var data = {
  prompt: "Suggest one positive thing I can do based on my mood.\n Mood:".concat(moodInput),
  temperature: 0.9,
  max_tokens: 64,
  top_p: 1.0,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return fetch("https://api.openai.com/v1/engines/text-curie-001/completions", {
              ...
              headers: {
                ...
                Authorization: "Bearer ".concat(myKey)
              },
          ...
          case 5:
            ...
            return _context.abrupt("return", answer.choices[0].text);
...
submitButton.addEventListener('click', function () {
  ...
  getResponse().then(function (text) {
    ...
    var taskHTML = taskArray.map(function (element) {
      return getTaskHTML(element);
    });
